...
// ------------WORK-TASKS------------
    ...
    _todo_list_js__WEBPACK_IMPORTED_MODULE_0__.todoList.addTask(
        ...
        "",
        (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(), "yyyy-MM-dd"),
        "medium",
        "Work"
    );
...
/* harmony import */ var _task_display_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./task-display-controller.js */ "./src/task-display-controller.js");
...
class RenderElement {
    ...
    taskContent(task) {
        ...
        taskInfoFirstDiv.append((0,_task_display_controller_js__WEBPACK_IMPORTED_MODULE_3__.taskPriorityHandler)(task));
        ...
        dueDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(task.dueDate, "dd MMM yy");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   taskPriorityHandler: () => (/* binding */ taskPriorityHandler),
/* harmony export */   updateNumberOfTasks: () => (/* binding */ updateNumberOfTasks),
/* harmony export */   updateNumberOfTasksHeader: () => (/* binding */ updateNumberOfTasksHeader),
/* harmony export */   updateNumberOfTasksProjectButtons: () => (/* binding */ updateNumberOfTasksProjectButtons),
/* harmony export */   updateNumberOfTasksTasksButton: () => (/* binding */ updateNumberOfTasksTasksButton)
/* harmony export */ });
/* harmony import */ var _todo_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo-list */ "./src/todo-list.js");
...
function taskPriorityHandler(task) {
...
function updateNumberOfTasksTasksButton() {
  ...
  tasksButtons.forEach((button) => { 
    ...
    if (button.classList.contains("all-tasks-button")) {     
      tasksNumber = _todo_list__WEBPACK_IMPORTED_MODULE_0__.todoList.tasks.length;       
    };
    
    if (button.classList.contains("today-tasks-button")) {
      const todayTasksArray = _todo_list__WEBPACK_IMPORTED_MODULE_0__.todoList.tasks.filter(element => {
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(element.dueDate)) {            
          return element;
          };         
        });  
    ...
    if (button.classList.contains("overdue-tasks-button")) {     
      const overdueTasksArray = _todo_list__WEBPACK_IMPORTED_MODULE_0__.todoList.tasks.filter(element => {
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isPast)(element.dueDate) && !(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(element.dueDate)) {            
          return element;
          };                  
        });           
...
function updateNumberOfTasksHeader(project) {
    ...
    if (headerName === "Overdue") {     
      ...
      taskContainerHeaderSpan.innerHTML = `(${_todo_list__WEBPACK_IMPORTED_MODULE_0__.todoList.getTasksByProject(project).length})`;     
} 
...
class TodoList {
    ...
    addProject(value) {
        ...
        this.#projects.push(new _project_js__WEBPACK_IMPORTED_MODULE_1__["default"](value));
    };
    ...
    addTask(name, description, notes, dueDate, priority, project, id) {
        this.#tasks.push(new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"](name, description, notes, dueDate, priority, project, id = Math.random().toString(16).slice(2)));      
    };
    ...
    getTodayTasks() {
        const todayTasks = this.#tasks.filter(element => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isToday)(element.dueDate)) {                                  
              return element;
              };                   
            });
    ...
    getOverdueTasks() {
        const overdueTasks = this.#tasks.filter(element => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.isPast)(element.dueDate) && !(0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isToday)(element.dueDate)) {            
              return element;
              };                  
            }); 
    ...
    fromString(todoListString) {
        ...
        this.#projects = parsedTodoList.projects.map(project => _project_js__WEBPACK_IMPORTED_MODULE_1__["default"].FromObject(project));
        this.#tasks = parsedTodoList.tasks.map(task => _task_js__WEBPACK_IMPORTED_MODULE_2__["default"].FromObject(task));
    }
};
...
/* harmony import */ var _task_display_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./task-display-controller.js */ "./src/task-display-controller.js");
...
class Ui {
    render(title) {
        _storage_js__WEBPACK_IMPORTED_MODULE_3__["default"].Load();
    ...
    renderSidebarTasksButtons() {
        ...
        (0,_task_display_controller_js__WEBPACK_IMPORTED_MODULE_2__.updateNumberOfTasksTasksButton)(); 
    ...
    renderSidebarProjectsButtons() {
        ...
        (0,_task_display_controller_js__WEBPACK_IMPORTED_MODULE_2__.updateNumberOfTasksProjectButtons)();       
    };
    ...
    renderTasksContainerHeader(title) { 
        ...
        if (!title) {
            ...
            (0,_task_display_controller_js__WEBPACK_IMPORTED_MODULE_2__.updateNumberOfTasksHeader)();  
        } else {            
            headerTitle.innerHTML = title;
            (0,_task_display_controller_js__WEBPACK_IMPORTED_MODULE_2__.updateNumberOfTasksHeader)(title); 
            }; 
