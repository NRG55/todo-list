...
class TodoList {
    ...
    getOverdueTasks() {
        return this.#tasks.filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isPast)(task.dueDate));       
    };
